// Shared content for Alexander Horison portfolio — used by the mobile, tablet and desktop layouts.
// Scraped + condensed from alexander-horison.framer.website, plus AI-builder work added by the owner.
window.AXP = {
  identity: {
    name: "Alexander Horison",
    title: "AI Builder & Technology Consultant",
    roles: "AI Builder · Solution Architect · Web Developer",
    tagline: "Proven to build solutions that improve productivity.",
  ...
  stats: [
    ...
    { value: "AI", label: "Builder & automation" },
  ],
  services: [
  ...
  tools: ["Claude", "ChatGPT", "Cursor", "n8n", "Figma", "Framer", "Webflow", "Retool", "Filament", "Glide apps", "Jira", "Confluence", "Slack", "WordPress", "VS Code"],
  experience: [
  ...
  education: { school: "Bina Nusantara University", degree: "Bachelor's Degree in Information Technology" },
  learning: [
  ...
  // category: "ai" = AI & Automation builds · "product" = apps & web products
  projects: [
